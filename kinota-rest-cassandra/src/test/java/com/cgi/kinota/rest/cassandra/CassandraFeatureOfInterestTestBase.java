 ...
 */
public abstract class CassandraFeatureOfInterestTestBase extends CassandraRestTestBase {

    public static final String URL_PATH_BASE = API_VERSION + FeatureOfInterest.NAME_PLURAL;
