 ...
 */
public abstract class CassandraObservationTestBase extends CassandraRestTestBase {

    public static final String URL_PATH_BASE = API_VERSION + Observation.NAME_PLURAL;
