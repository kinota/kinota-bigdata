 ...
 */
public abstract class CassandraDatastreamTestBase extends CassandraRestTestBase {

    public static final String URL_PATH_BASE = API_VERSION + Datastream.NAME_PLURAL;
