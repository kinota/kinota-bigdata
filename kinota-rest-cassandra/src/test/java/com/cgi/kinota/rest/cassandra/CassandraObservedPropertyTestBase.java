 ...
 */
public abstract class CassandraObservedPropertyTestBase extends CassandraRestTestBase {

    public static final String URL_PATH_BASE = API_VERSION + ObservedProperty.NAME_PLURAL;
